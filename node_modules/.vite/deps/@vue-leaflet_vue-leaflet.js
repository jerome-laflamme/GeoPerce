...
var cancelDebounces = function(handlerMethods) {
...
var propsBinder = (methods, leafletElement, props) => {
...
var propsToLeafletOptions = (propValues, propDefinitions, baseOptions = {}) => {
...
var resetWebpackIcon = async (Icon) => {
  const modules = await Promise.all([
    import("/Users/alex/Desktop/geoperce-frontend/node_modules/leaflet/dist/images/marker-icon-2x.png"),
    import("/Users/alex/Desktop/geoperce-frontend/node_modules/leaflet/dist/images/marker-icon.png"),
    import("/Users/alex/Desktop/geoperce-frontend/node_modules/leaflet/dist/images/marker-shadow.png")
  ]);
...
var setupLayer = (props, leafletRef, context) => {
...
var setupInteractiveLayer = (props, leafletRef, context) => {
...
var setupPath = (props, leafletRef, context) => {
  const {
...
var setupCircleMarker = (props, leafletRef, context) => {
...
var setupCircle = (props, leafletRef, context) => {
  const {
...
var script = {
  ...
  setup(props, context) {
    ...
    onMounted(async () => {
      const { circle, DomEvent } = useGlobalLeaflet ? WINDOW_OR_GLOBAL.L : await import("./leaflet-src.esm-CDAPP6OT.js");
...
var script$1 = {
  ...
  setup(props, context) {
    ...
    onMounted(async () => {
      const { circleMarker, DomEvent } = useGlobalLeaflet ? WINDOW_OR_GLOBAL.L : await import("./leaflet-src.esm-CDAPP6OT.js");
...
var setupControl = (props, leafletRef) => {
  const {
    options: componentOptions,
    methods: componentMethods
  } = setupComponent(props);
...
var script$2 = {
  ...
  setup(props, context) {
    ...
    onMounted(async () => {
      const { Control, DomEvent } = useGlobalLeaflet ? WINDOW_OR_GLOBAL.L : await import("./leaflet-src.esm-CDAPP6OT.js");
...
var controlAttributionProps = {
  ...controlProps,
  prefix: {
    type: String
  }
};
var setupControlAttribution = (props, leafletRef) => {
...
var script$3 = {
  ...
  setup(props, context) {
    ...
    onMounted(async () => {
      const { control } = useGlobalLeaflet ? WINDOW_OR_GLOBAL.L : await import("./leaflet-src.esm-CDAPP6OT.js");
...
var setupControlLayers = (props, leafletRef) => {
...
var setupControlScale = (props, leafletRef) => {
  const { options: controlOptions, methods: controlMethods } = setupControl(
    props,
    leafletRef
  );
...
var setupControlZoom = (props, leafletRef) => {
  const { options: controlOptions, methods: controlMethods } = setupControl(
    props,
    leafletRef
  );
...
var setupLayerGroup = (props, leafletRef, context) => {
...
var featureGroupProps = {
  ...layerGroupProps
};
var setupFeatureGroup = (props, leafletRef) => {
...
var script$7 = {
  ...
  setup(props, context) {
    ...
    onMounted(async () => {
      const { featureGroup, DomEvent } = useGlobalLeaflet ? WINDOW_OR_GLOBAL.L : await import("./leaflet-src.esm-CDAPP6OT.js");
...
var setupGeoJSON = (props, leafletRef, context) => {
  const { options: layerOptions, methods: layerGroupMethods } = setupLayerGroup(
    props,
    leafletRef,
    context
...
var script$8 = {
  ...
  setup(props, context) {
    ...
    onMounted(async () => {
      const { geoJSON, DomEvent } = useGlobalLeaflet ? WINDOW_OR_GLOBAL.L : await import("./leaflet-src.esm-CDAPP6OT.js");
...
var setupGridLayer = (props, leafletRef, context) => {
  const { options: layerOptions, methods: layerMethods } = setupLayer(
    props,
    leafletRef,
    context
...
var script$9 = {
  ...
  setup(props, context) {
    ...
    onMounted(async () => {
      const { GridLayer, DomEvent, DomUtil } = useGlobalLeaflet ? WINDOW_OR_GLOBAL.L : await import("./leaflet-src.esm-CDAPP6OT.js");
      methods.onUnload = (e) => {
...
var script$a = {
  ...
  setup(props, context) {
    ...
    onMounted(async () => {
      const { DomEvent, divIcon: lDivIcon, icon: lIcon } = useGlobalLeaflet ? WINDOW_OR_GLOBAL.L : await import("./leaflet-src.esm-CDAPP6OT.js");
...
var setupImageOverlay = (props, leafletRef, context) => {
  const { options: layerOptions, methods: layerMethods } = setupLayer(
    props,
    leafletRef,
    context
...
var script$b = {
  ...
  setup(props, context) {
    ...
    onMounted(async () => {
      const { imageOverlay, DomEvent } = useGlobalLeaflet ? WINDOW_OR_GLOBAL.L : await import("./leaflet-src.esm-CDAPP6OT.js");
...
var script$c = {
  ...
  setup(props, context) {
    ...
    onMounted(async () => {
      const { layerGroup, DomEvent } = useGlobalLeaflet ? WINDOW_OR_GLOBAL.L : await import("./leaflet-src.esm-CDAPP6OT.js");
  ...
  setup(props, context) {
    ...
    onMounted(async () => {
      if (props.useGlobalLeaflet) {
        WINDOW_OR_GLOBAL.L = WINDOW_OR_GLOBAL.L || await import("./leaflet-src-MPG72EH4.js");
      }
      const {
        map,
        CRS,
        ...
        latLng,
        DomEvent
      } = props.useGlobalLeaflet ? WINDOW_OR_GLOBAL.L : await import("./leaflet-src.esm-CDAPP6OT.js");
      try {
...
var setupMarker = (props, leafletRef, context) => {
  const { options: layerOptions, methods: layerMethods } = setupLayer(
    props,
    leafletRef,
    context
...
var shouldBlankIcon = (options, context) => {
  const slotContent = context.slots.default && context.slots.default();
  if (slotContent && slotContent.some((el) => !["LTooltip", "LPopup"].includes(el.type.name))) {
    return true;
  }
  return false;
};
var script$e = {
  ...
  setup(props, context) {
    ...
    onMounted(async () => {
      const { marker, DomEvent, divIcon } = useGlobalLeaflet ? WINDOW_OR_GLOBAL.L : await import("./leaflet-src.esm-CDAPP6OT.js");
...
var setupPolyline = (props, leafletRef, context) => {
  const { options: pathOptions, methods: pathMethods } = setupPath(
    props,
    leafletRef,
    context
...
var setupPolygon = (props, leafletRef, context) => {
...
var script$f = {
  ...
  setup(props, context) {
    ...
    onMounted(async () => {
      const { polygon, DomEvent } = useGlobalLeaflet ? WINDOW_OR_GLOBAL.L : await import("./leaflet-src.esm-CDAPP6OT.js");
...
var script$g = {
  ...
  setup(props, context) {
    ...
    onMounted(async () => {
      const { polyline, DomEvent } = useGlobalLeaflet ? WINDOW_OR_GLOBAL.L : await import("./leaflet-src.esm-CDAPP6OT.js");
...
var setupPopper = (props, leafletRef) => {
...
var setupPopup = (props, leafletRef) => {
...
var script$h = {
  ...
  setup(props, context) {
    ...
    onMounted(async () => {
      const { popup, DomEvent } = useGlobalLeaflet ? WINDOW_OR_GLOBAL.L : await import("./leaflet-src.esm-CDAPP6OT.js");
      leafletRef.value = markRaw(popup(options));
      if (props.latLng !== void 0) {
...
var setupRectangle = (props, leafletRef, context) => {
...
var script$i = {
  ...
  setup(props, context) {
    ...
    onMounted(async () => {
      const { rectangle, latLngBounds, DomEvent } = useGlobalLeaflet ? WINDOW_OR_GLOBAL.L : await import("./leaflet-src.esm-CDAPP6OT.js");
...
var setupTileLayer = (props, leafletRef, context) => {
  const {
...
var script$j = {
  ...
  setup(props, context) {
    ...
    onMounted(async () => {
      const { tileLayer, DomEvent } = useGlobalLeaflet ? WINDOW_OR_GLOBAL.L : await import("./leaflet-src.esm-CDAPP6OT.js");
...
var setupTooltip = (props, leafletRef) => {
  const { options, methods } = setupPopper(props, leafletRef);
...
var script$k = {
  ...
  setup(props, context) {
    ...
    onMounted(async () => {
      const { tooltip, DomEvent } = useGlobalLeaflet ? WINDOW_OR_GLOBAL.L : await import("./leaflet-src.esm-CDAPP6OT.js");
...
var setupWMSTileLayer = (props, leafletRef) => {
  const {
